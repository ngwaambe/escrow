...
ALTER TABLE activation_link DROP COLUMN customer_id;
ALTER TABLE activation_link ADD COLUMN user_id BIGINT not null AFTER dtype;
ALTER TABLE activation_link ADD CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES users(id);
