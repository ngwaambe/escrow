...
<br/>
<br/>
Has sido invitado a participar en una nueva transacción de confianza en sicuro.com.<br/>
<b>sicuro.com es la mejor manera de realizar de forma segura tus transacciones online.</b>
</p>

<p class="paragraph" style="font-family: 'lucida grande',Tahoma,Geneva,sans-serif; font-size: 13px; line-height: 1.28; text-align: left; color: #555; margin:10px;">
El ${initiatorRole} (${initiatorName}) ha elegido el servicio de confianza de sicuro.com para llevar a cabo el acuerdo alcanzado contigo. Con este email queremos informarte de la última novedad de esta transacción:
</p>
...
<p class="paragraph" style="font-family: 'lucida grande',Tahoma,Geneva,sans-serif; font-size: 13px; line-height: 1.28; text-align: left; color: #555; margin:10px;">
Si ya eres usuario de sicuro.com <a href="${loginlink}">accede</a> a tu cuenta en sicuro.com para aceptar los términos de esta transacción.
Si hasta ahora nunca has usado sicuro.com por favor <a href='${registrationlink}'>regístrate</a> en nuestra página usando tu dirección de email ${email}.
</p>
