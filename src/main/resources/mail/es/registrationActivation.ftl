...
Estimado/a ${name},
<br/>
 gracias por registrarte en sicuro.com. Por favor pincha en el siguiente enlace para activar tu cuenta.
 <a href="${link}"><b>Activar cuenta</b></a>
 <br/>
 En caso de que no funcionara el enlace copia y pega el enlace siguiente en tu navegador web.<br>
 <b>${link}</b>
</p>
...
¡Muchas gracias por tu confianza en nosotros! Esperamos poder asistirte muy pronto en tus compras y ventas online.
</p>
