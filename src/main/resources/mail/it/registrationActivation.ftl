...
<p style="font-family: 'lucida grande',Tahoma,Geneva,sans-serif; font-size: 13px; line-height: 1.28; text-align: left; color: #555; margin:10px;">
 Gentile ${name},
<br/>
 Grazie per esserti registrato a sicuro.com.

 Ti preghiamo di cliccare sul seguente link per attivare il tuo account.
 <a href="${link}"><b>Attiva il tuo account</b></a>
 <br/>
