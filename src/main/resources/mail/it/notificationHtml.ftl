...
<br/>
<br/>
Sei invitato a partecipare ad una nuova transazione su sicuro.com. <br/>
<b>Con sicuro.com acquisti e vendi online in totale sicurezza.</b>
</p>

<p class="paragraph" style="font-family: 'lucida grande',Tahoma,Geneva,sans-serif; font-size: 13px; line-height: 1.28; text-align: left; color: #555; margin:10px;">
Il ${initiatorRole} (${initiatorName}) ha scelto sicuro.com per completare l’accordo che avete raggiunto.
Con questa e-mail ti segnaliamo l’ultimo aggiornamento della transazione:
</p>
...
<p class="paragraph" style="font-family: 'lucida grande',Tahoma,Geneva,sans-serif; font-size: 13px; line-height: 1.28; text-align: left; color: #555; margin:10px;">
Se è la prima volta che usi  sicuro.com, sei pregato di accedere con lo username
${email} per <a href='${registrationlink}'>Registrarti</a> al sito.
Se invece sei già un nostro cliente, utilizza il tuo indirizzo e-mail ${email}
per effettuare il <a href="${loginlink}"><b>login.</b></a>
</p>
