...
<p  style="font-family: 'lucida grande',Tahoma,Geneva,sans-serif; font-size: 13px; line-height: 1.28; text-align: left; color: #555; margin:10px;">
 In order to be sure that you are really the owner of this account, you are requested to click on the following
 <a href="${link}"><b>link</b></a>. You will then be asked to answer a security question, which you choosed and answered
 creating this account. After you must have successfully identified your self as owner of the account, you will receive
 an email with the necessary information to reset your password.
 </p>
 <p  style="font-family: 'lucida grande',Tahoma,Geneva,sans-serif; font-size: 13px; line-height: 1.28; text-align: left; color: #555; margin:10px;">
 Should you not be able to click on the link, please copy the link below and paste in browser navigation bar<br/>
 ${link}
 </p>
