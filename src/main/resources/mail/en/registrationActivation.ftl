...
Dear ${name},
<br/>
 thank you for registering with sicuro.
 <br/>
 Please click on the following link to activate your account.
 <a href="${link}"><b>Activate account</b></a>
 <br/>
 <br/>
 In case the link does not function please copy the link below
 and paste into your browser of choice.<br>
 <b>${link}</b>
</p>
<p style="font-family: 'lucida grande',Tahoma,Geneva,sans-serif; font-size: 13px; line-height: 1.28; text-align: left; color: #555; margin:10px;">
